...
class BWFleck {
    ...
    primaryWeaponMagazine = "rhssaf_30rnd_556x45_EPR_G36";
		primaryWeaponOptics = "hlc_optic_HensoldtZO_lo_Docter";
    ...
    class soldier_UAV_F {
      uniform = "LOP_U_CHR_Functionary_02";
      vest = "";
      backpack = "";
      headgear = "";
      primaryWeapon = "";
    ...
    class soldier_UAV_06_medical_F{
      uniform = "LOP_U_CHR_Functionary_01";
  		vest = "";
  		backpack = "";
  		headgear = "";
  		primaryWeapon = "hlc_smg_mp5a3";
      primaryWeaponMagazine = "hlc_30Rnd_9x19_B_MP5";
  		primaryWeaponOptics = "";
  		primaryWeaponPointer = "";
  		primaryWeaponMuzzle = "";
      primaryWeaponUnderbarrel = "";
